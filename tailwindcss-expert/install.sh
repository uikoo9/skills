...
# Tailwind CSS Expert Skill 安装脚本

echo "================================"
echo "Tailwind CSS Expert Skill"
echo "安装程序"
echo "================================"
echo ""
...
echo "================================"
echo ""
echo "现在可以开始使用 Tailwind CSS Expert skill 了！"
echo ""
echo "测试方法："
echo "1. 打开 Claude Code"
echo "2. 提问: '用 Tailwind CSS 创建一个按钮'"
echo "3. 如果 skill 正常工作，Claude 会提供完整的 HTML 和准确的类名"
echo ""
